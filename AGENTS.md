...
- `apps/app-server/src/main.ts`
- `apps/app-server/src/app.module.ts`
- `apps/app-server/src/app.controller.ts`
- `apps/app-server/src/app.service.ts`
- `apps/app-server/src/common/`
- `apps/app-server/src/database/`
- `apps/app-server/src/modules/README.md`
- `apps/app-server/scripts/test.mjs`
- `apps/app-server/scripts/check-format.mjs`
- `apps/app-server/package.json`
- `apps/app-server/package-lock.json`
- `apps/app-server/tsconfig.json`
- `apps/app-server/tsconfig.build.json`
- `apps/app-server/Dockerfile`

도메인 모듈을 `apps/app-server/src/app.module.ts`에 등록하거나 제거하는 작업도 app bootstrap 변경이므로 공통 영역 변경으로 기록한다.
...
| App server common areas | `apps/app-server/APP_SERVER_COMMON_AREAS.md` |
