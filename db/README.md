...
- `migrations/099_create_agent_candidate_selections.sql` adds short-lived, one-time server-owned Agent clarification candidates. Browser clients receive only the opaque candidate ID; resource references remain behind the App Server and all-deny RLS.
