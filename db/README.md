...
- `migrations/051_create_user_settings_and_account_lifecycle.sql` adds one settings row per user for PILO profile overrides and personal environment preferences, adds the account-deletion tombstone timestamp, and enables all-deny RLS for settings.
