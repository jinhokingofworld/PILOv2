...
- `migrations/076_add_agent_contextual_execution.sql` adds immutable Agent request context, choice confirmation selection state, and the SQLtoERD Agent session-creation idempotency ledger.
