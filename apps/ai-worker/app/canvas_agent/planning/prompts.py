...
def system_prompt() -> str:
    return (
        ...
        "HTML/CSS draft from an explicitly selected Canvas scene. "
        ...
        "nor an existing Drive image import, choose unsupported. Never reinterpret an unrelated "
        "mutation request as a search. "
