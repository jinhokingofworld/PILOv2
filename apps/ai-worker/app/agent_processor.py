...
def _agent_planner_system_prompt() -> str:
    return (
        ...
        "candidates include sessionSelectionToken, copy the exact selected token into the next "
        "inspect_sql_erd_schema call instead of retrying by title. The inspection projection "
