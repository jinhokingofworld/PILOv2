...
assert.match(events, /sql-erd:table-move:preview/);
assert.match(events, /sql-erd:table-move:clear/);
...
assert.match(socketServer, /sqlErdClientEvents\.tableMovePreview/);
assert.match(socketServer, /sqlErdClientEvents\.tableMoveClear/);
assert.match(socketServer, /join SQLtoERD room before sending table move previews/);
assert.match(socketServer, /join SQLtoERD room before clearing table move previews/);
