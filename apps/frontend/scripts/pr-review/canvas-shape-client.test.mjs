    ...
    operations: [
      {
        id: "operation-4",
        canvasId: "canvas-1",
        shapeId: "shape:pr-review-file:room-file-1",
...
await client.listReviewCanvasOperations("workspace-1", "canvas-1", 3);
...
assert.deepEqual(
  ...
  [
    ...
    "https://api.example.test/api/v1/workspaces/workspace-1/canvases/canvas-1/operations?afterSeq=3",
...
assert.equal(requests[4].init.headers.get("Authorization"), "Bearer token");
