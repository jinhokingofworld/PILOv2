...
assert.match(canvasRealtimeTypes, /"canvas:shape:commit"/);
assert.match(canvasRealtimeTypes, /CanvasShapeCommitAck/);
...
assert.match(canvasPresenceHook, /SHAPE_COMMIT_ACK_TIMEOUT_MS = 10_000/);
assert.match(canvasPresenceHook, /canvas:shape:commit/);
assert.match(canvasPresenceHook, /CanvasRealtimeCommitError/);
