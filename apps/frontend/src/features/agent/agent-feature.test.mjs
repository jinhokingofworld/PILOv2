...
assert.match(agentChatWidget, /내 이슈 확인/);
assert.match(agentChatWidget, /현재 PR 보기/);
assert.match(agentChatWidget, /prompt: "오늘 일정 보여줘"/);
assert.match(agentChatWidget, /prompt: "내 이슈 보여줘"/);
assert.match(agentChatWidget, /prompt: "현재 PR 보여줘"/);
