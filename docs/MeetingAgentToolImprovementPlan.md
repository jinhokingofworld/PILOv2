...
- [ ] **4-B. Meeting 자연어 read selector를 구조화한다.**
...
- [ ] **4-C. #1355 bounded thread context를 완료한다.**
...
- [ ] **4-D. Meeting 후보 선택 뒤 original goal 재개를 연결한다.**
  - 선행: Phase 3, 4-B, 4-C.
  ...
  - 완료 기준: 0/N·만료·stale·다른 user/Workspace/run/thread 후보는 write/confirmation 없이
    clarification으로 끝나고, 정상 선택은 원래 요청을 한 번만 재개한다.
